...
export class Experiance extends Basic {
  static renderExperiance(projects, works) {
    ...
    works.map((item) => {
      ...
      const workImg = this.createElement("img", "workImg", null, `https://vanilla-js-back-end.web.app${item.img}`);
    ...
    projects.map((proj) => {
      ...
      const projectWindow = this.createElement("img", "projectWindow", "Open", `https://vanilla-js-back-end.web.app${proj.img}` ,"projectWindow");
