...
export class Skill extends Basic {
  static renderSkills(skillsArr) {
    ...
    skillsArr.reverse().map((item) => {
      ...
      const imgFront = this.createElement("img", "skillDivContent", null, "/images/star.png");
      const imgBack = this.createElement("img", "skillDivContentBack", null, "/images/star.png");
