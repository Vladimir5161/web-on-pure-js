...
export class Skill extends Basic {
  static renderSkills(skillsArr) {
    ...
    skillsArr.reverse().map((item) => {
      ...
      const imgFront = this.createElement("img", "skillDivContent", null, "https://vanilla-js-back-end.web.app/images/star.png");
      const imgBack = this.createElement("img", "skillDivContentBack", null, "https://vanilla-js-back-end.web.app/images/star.png");
