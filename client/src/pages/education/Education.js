...
export class Education extends Basic {
  static renderEducation(educationArray) {
    ...
    educationArray.map((item) => {
      ...
      const educationImg = this.createElement("img", "educationImg" ,null, item.src);
      const educationImgDiv = this.createElement("div", "educationImgDivClosed", null, null, "educationImgDiv");
      const educationImgStart = this.createElement("img", "educationImgClosed", null,  item.src, "educationImgClosed");
