...
export class AboutMe extends Basic {
    static async renderAboutPage(contactsArr) {
        ...
        const imgBig = this.createElement("img", "blockImage", null, this.getImageURl('me.jpg'));
        const imgSmall = this.createElement("img", "blockImageSmall", null, this.getImageURl('me.jpg'));
       ...
       `;
        ...
        for (let item in contactsArr) {
            ...
            const contactImg = this.createElement("img", "contactImg", null, this.getImageURl(`${objKey}.png`));
