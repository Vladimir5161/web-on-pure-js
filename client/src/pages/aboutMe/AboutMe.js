...
export class AboutMe extends Basic {
    static async renderAboutPage(contactsArr) {
        ...
        const imgBig = this.createElement("img", "blockImage", null, "/images/me.jpg");
        const imgSmall = this.createElement("img", "blockImageSmall", null, "/images/me.jpg");
       ...
       `;
        ...
        for (let item in contactsArr) {
            ...
            const contactImg = this.createElement("img", "contactImg", null, `/images/${objKey}.png`);
