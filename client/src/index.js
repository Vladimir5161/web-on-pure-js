...
function getBackgroundURL(dayTime) {
  return `url(https://us-central1-vanilla-js-about-me.cloudfunctions.net/app/images/${dayTime ? 'day' : 'night'}.jpg)`
}
...
let observer = new MutationObserver((mutationRecords) => {
  if (mutationRecords[0].addedNodes[0].className === "headerDiv") {
    ...
    const setTheme = async (theme) => {
      if (theme === "black") {
        main.style.backgroundImage = getBackgroundURL(false);
        ...
        main.style.backgroundImage = getBackgroundURL(true);
